...
public class MyLogger {
    ...
    public static void logError(String nombreClase, String mensajeError, Exception e) {
        ...
        if (comprobarDirectorio(CARPETA_LOGS)) {
            ...
            try (BufferedWriter bw = new BufferedWriter(new FileWriter(archivo))) {
                String hora = LocalDate.now().format(DateTimeFormatter.ofPattern("HH:mm:ss"));
    ...
    public static void logInfo(String nombreClase, String mensajeInfo){
        if(comprobarDirectorio(CARPETA_LOGS)){
            String fecha = LocalDate.now().toString();
            String nombreArchivo = "log" + fecha + "_" + nombreClase + ".txt";
            ...
            try(BufferedWriter bw = new BufferedWriter(new FileWriter(archivo, true))) {
                ...
                bw.write("["+ hora + "] INFO" + mensajeInfo + "\n" );
                bw.newLine();
