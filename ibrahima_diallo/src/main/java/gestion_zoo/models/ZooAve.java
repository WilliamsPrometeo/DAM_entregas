...
public class ZooAve extends Animal {

    public boolean colorOscuro;
    /**
     * Constructor principal de la clase Ave que hereda de animal que es su clase padre
    ...
    public ZooAve(String idAnimal, LocalDate fechaRegistro, boolean colorOscuro) {
    ...
    /**
     * Se hace un override para establecer que el tipo de animal es un ave en este caso
     * @return Animal Ave
     */
    ...
    public String toString() {
        ...
        return String.format("Ave: %s - %s -%s -%s ", getIdAnimal(), registro, oscuro, this.colorOscuro);
    }
