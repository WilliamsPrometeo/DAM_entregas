package proyecto_03.utilidades;
...
public class Utilidades {
    ...
    private static final String RUTA = "Proyecto_03/datos/";
    ...
    public static boolean existDirectorio(String ruta){
        File directorio = new File(ruta);
        return directorio.exists();
    }

    /**
     * Añade texto al final de un fichero (crea el fichero si no existe).
     * Uso de FileWriter con append=true y try-with-resources.
     *
     * @param rutaCompleta ruta absoluta del fichero
     * @param contenido    texto a añadir
     * @return true si la operación ha tenido éxito, false en caso contrario
     */
    public static boolean appendTextoArchivo(String rutaCompleta, String contenido) {
