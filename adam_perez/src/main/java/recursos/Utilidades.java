...
public class Utilidades {
    ...
    /**
     * Metodo para garantizar que existe un directorio
     * @param ruta String con la ruta a verificar
    ...
    /**
     * Metodo para poder listar los archivos que componen un fichero
     * @param ruta String con la ruta donde buscar el fichero
     */

    public static void listaDeArchivos(String ruta) {
        File directorio = new File(ruta);
            ...
            if (archivos != null) {
                for (File file : archivos) {
                    if (file.isFile()) {
                        ...
                        listarArchivos(ruta+"/"+file.getName());
                    }
                }
            } else {
                System.out.println("Directorio vacio");
