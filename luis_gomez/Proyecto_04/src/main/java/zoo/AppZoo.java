...
public class AppZoo {
    ...
    public static void main(String[] args) {
        MyLogger.logInfo(AppZoo.class.getSimpleName(),"Iniciando programa");
        menu();
        MyLogger.logInfo(AppZoo.class.getSimpleName(),"Terminando programa");
    }

    private static void menu() {
        MyLogger.logInfo(AppZoo.class.getSimpleName(), "Iniciando Menu");
        boolean correcto = false;
        int opcion;
        do {
            opcion = sc.pedirNumero("==========Bienvenido al ZOO==========\n" +
                    "1. Registrar animal\n" +
                    "2. Listar animales\n" +
                    "3. Buscar animal\n" +
                    "4. Eliminar animal\n" +
