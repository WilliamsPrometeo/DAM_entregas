...
public class AnimalController {
    ...
    public void addAnimal() {
        ...
        do {
            ...
            numAnimal = getCodigo();
            try {
                service.animalValido(numAnimal);
        ...
        do {
            ...
            int opcion = sc.pedirNumero("¿Qué animal quieres registrar?: " +
                    "\n1. Registrar Mamifero" +
                    "\n2. Registrar Ave" +
                    "\nOpcion: ");
            switch (opcion) {
                case 1:
                    service.addAnimal(new Mamifero(numAnimal, fecharegistro, 50),
                            Utilidades.pedirEnum(Habitat.class, "Introduce el tipo de animal: "));
                    break;
                case 2:
                    service.addAnimal(new Ave(numAnimal, fecharegistro, esRapaz()),
                            Utilidades.pedirEnum(Habitat.class, "Introduce el tipo de animal: "));
                    break;
                default:
    ...
    private boolean esRapaz() {
        ...
        do {
            correcto = true;
            char opcion = sc.pedirLetra("¿Es un ave rapaz? (S/N): ");
            switch (opcion) {
                case 'S':
                case 's':
                    salida = true;
